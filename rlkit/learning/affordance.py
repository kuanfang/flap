...
from rlkit.torch.sac.affordance_trainer import AffordanceTrainer  # NOQA
...
from rlkit.envs.contextual_env import SubgoalContextualEnv  # NOQA
from rlkit.envs.contextual_env import NonEpisodicSubgoalContextualEnv  # NOQA
from rlkit.learning.affordance_replay_buffer import AffordanceReplayBuffer  # NOQA
...
def affordance_experiment(  # NOQA
        max_path_length,
        qf_kwargs,
        vf_kwargs,
        obs_encoder_kwargs,
    ...
    env, training_context_distrib, reward_fn = (
