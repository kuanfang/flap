...
from rlkit.vae import network_utils
...
class CcVae(PyTorchModule):
    ...
    def __init__(
        ...
        print('unet_inner_dim: ', unet_inner_dim)
        print('z_fc_dim: ', z_fc_dim)
...
class HierarchicalCcVae(PyTorchModule):
    ...
    def __init__(
        ...
        try:
            # self.data_channels = self._networks[0].data_channels
            self.data_root_len = self._networks[0].data_root_len
            for network in self._networks:
                # assert self.data_channels == network.data_channels
